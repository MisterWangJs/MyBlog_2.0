...
import wjs.blog.utils.PageBeanUser;
...
public class UserListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PageBeanUser<User> pageBeanUser = new PageBeanUser<User>(pageIndex, count, this.pageSize, list);
 		pageBeanUser.init();
 		
 		//6.跳转到 学生列表页面 list_stu.jsp
 		request.setAttribute("pageBeanUser", pageBeanUser);
 		RequestDispatcher rd = request.getRequestDispatcher("./User/user_list.jsp");
