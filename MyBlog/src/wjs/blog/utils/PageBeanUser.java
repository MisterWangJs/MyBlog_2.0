...
public class PageBeanUser<T> {
	...
	public PageBeanUser(int pageIndex, int count, int pageSize) {
		super();
	...
	public PageBeanUser(int pageIndex, int count, int pageSize, List<T> list) {
		super();
		this.pageIndex = pageIndex;
		this.count = count;
		this.pageSize = pageSize;
