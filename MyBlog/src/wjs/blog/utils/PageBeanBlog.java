...
public class PageBeanBlog<T> {
	...
	public PageBeanBlog(int pageIndex, int count, int pageSize) {
		super();
	...
	public PageBeanBlog(int pageIndex, int count, int pageSize, List<T> list) {
		super();
		this.pageIndex = pageIndex;
		this.count = count;
		this.pageSize = pageSize;
